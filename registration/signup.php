...
<head>
    ...
    <style>
        ...
        .form-container {
            background-color: #191C24; /* Background color for the form */
            border-radius: 25px;
  ...
  <div class="collapse navbar-collapse" id="navbarCollapse">
    <div class="navbar-nav ms-auto p-4 p-lg-0">
      ...
      <a href="../contact.php" class="nav-item nav-link">Contact</a>
            ...
            <a href="../appointment.html" class="btn rounded-0 py-2 px-lg-4 d-none d-lg-block mr-2">Appointment<i class="fa fa-arrow-right ms-3"></i></a>
            <a href="signup.php" class="btn rounded-0 py-2 px-lg-4 d-none d-lg-block">Registration<i class="fa fa-arrow-right ms-3"></i></a>
        </div>
    </nav>
    <!-- Navbar End -->

<section class="vh-120" style="background-color: black;">
                ...
                <div class="card text-black" style="border-radius: 25px; background-color: #191C24;">
                    <div class="card-body p-md-2">
                        <div class="row justify-content-center">
                            <p class="text-center h1 fw-bold mb-4 mx-1 mx-md-3 mt-3" style="color:#d6a553;">Sign up</p>
                            <div class=" col-lg-9  ">
                                <form class="" action="insert.php" method="post">
                                    <div class="d-flex flex-row align-items-center mb-4">
                                        
                                        <div class="form-outline flex-fill mb-0">
                                        <i class="fas fa-user fa-lg me-3 fa-fw"></i><label class="form-label" for="">Name</label>
                                    ...
                                    <div class="d-flex flex-row align-items-center mb-4">
                                        ...
                                        <i class="fas fa-phone fa-lg me-3 fa-fw"></i>
                                            ...
                                            <input type="text" class="form-control form-control-lg py-3" name="contact" autocomplete="off" placeholder="Enter Your Contact Number" style="border-radius:15px;" />
                                        </div>
                                    </div>
                                    <div class="d-flex flex-row align-items-center mb-4">
                                        <div class="form-outline flex-fill mb-0">
                                    ...
                                    <div class="d-flex justify-content-center mb-3">
                                        <input type="submit" value="Register" name="register" class="btn  btn-lg text-dark my-1 py-3" style="width:100%; border-radius: 15px; font-weight:600;" />
                                    </div>
                                </form>
                                <p align="center">I have an account <a href="signin.php"  style="font-weight:600; text-decoration:none; color:#d6a553;" >Sign in</a></p>
                            </div>
        ...
        <div class="container">
            <div class="copyright">
                <div class="row">
                    ...
                    <div class="col-md-6 text-center text-md-end">Designed By <a class="border-bottom" href="https://htmlcodex.com">HTML Codex</a></div>
                </div>
            </div>
        </div>
    </div>
