        ...
        <div class="card  p-3 shadow-lg">
          ...
          ?>
            ...
            <form action="update_service.php" method="POST" enctype="multipart/form-data">
              <div class="mb-3">
                <input type="hidden" name="id" class="form-control" value="<?php echo htmlspecialchars($data['id']); ?>" required>
              </div>
              <div class="mb-3">
                <label>Title</label>
                <input type="text" name="st" class="form-control" value="<?php echo htmlspecialchars($data['Title']); ?>" required>
              </div>
              <div class="mb-3">
                <label>Description</label>
                <input type="text" name="sd" class="form-control" value="<?php echo htmlspecialchars($data['Description']); ?>" required>
              </div>
              <div class="mb-3">
                <label>Price</label>
                <input type="number" step="0.01" name="sp" class="form-control" value="<?php echo htmlspecialchars($data['Price']); ?>" required>
              </div>
              <div class="mb-3">
                <label>Image</label>
                <input type="file" name="img" value="<?php echo  'p_imgs/' .  htmlspecialchars($data['Image']); ?>" class="form-control">
                <small>Leave blank to keep the current image.</small>
              </div>
              <br>
              <div class="">
                <button type="submit" name="insert" class="btn btn-primary">Update Service</button>
                <a href="show_service.php" class="btn btn-warning">Show Data</a>
              </div>
            </form>
