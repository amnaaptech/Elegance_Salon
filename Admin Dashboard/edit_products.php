...
<body class="cbp-spmenu-push">
 ...
 <div class="sidebar" role="navigation">
    ...
    <div>
      <?php
      $editable = $_GET['editID'];
      //echo $edit;
      $select =  "SELECT * FROM `products` where id ='$editable';";
      ...
      ?>
          ...
          <div class="main-content">
            <div class="container">
              <h1 class="display-2 text-center my-5">Edit products</h1>

              <div class="card p-4 shadow-lg">
                <form action="update_products.php" method="post" enctype="multipart/form-data">

                  <div class="form-group mb-3">
                    <label for="p_img" class="font-weight-bold"></label>
                    <input type="hidden" name="id" class="form-control" id="id" value="<?php echo $show['id'] ?>" required>
                  </div>
                  <div class="form-group mb-3">
                    <label for="p_img" class="font-weight-bold">products Image:</label>
                    <input type="file" class="form-control" id="p_image" name="p_image" value="<?php echo './p_imgs/' . $show['product_Image']; ?>">

                  </div>

                  <div class="form-group mb-3">
                    <label for="p_t" class="font-weight-bold"> products name:</label>
                    <input type="text" name="p_name" class="form-control" id="p_t" value="<?php echo $show['Product_Title'] ?>" placeholder="Enter title" required>
                  </div>
                  <div class="form-group mb-3">
                    <label for="p_d" class="font-weight-bold">Products Description:</label>
                    <textarea name="p_Description" class="form-control" id="p_d" rows="3" placeholder="Enter description" required><?php echo htmlspecialchars($show['Product_Description']); ?></textarea>
                  </div>

                  <div class="form-group mb-3">
                    <label for="p_p" class="font-weight-bold">products Price:</label>
                    <input type="text" name="p_price" class="form-control" id="p_p" value="<?php echo $show['Product_Price'] ?>" placeholder="Enter price" required>
                  </div>
                  <div class="form-group mb-3">
                    <label for="p_p" class="font-weight-bold">products Quantity:</label>
                    <input type="text" name="p_quantity" class="form-control" id="p_q" value="<?php echo $show['prod_quantity'] ?>" placeholder="Enter price" required>
                  </div>
                  <div class="text-center">
                    <input type="submit" name="insert" class="btn btn-warning col-12 shadow mb-2 rounded" value="Submit">
                  </div>
                </form>
            <?php }
        } ?>
