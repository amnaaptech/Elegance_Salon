	...
	<div class="main-content">
		...
		<div class="main-content">
			...
			<div id="page-wrapper">
				<div class="main-page">
					<div class="tables">
						<h3 class="title1" style="color:black;">Customer List</h3>
								...
								<tbody>
									...
									?>
										<tr>
											...
											<td>
												<!-- Link to assign services to this appointment -->
												<a href="invoices.php?appointment_id=<?php echo $row['id']; ?>" class="btn btn-primary">Invoice</a>

												<!-- Link to delete the appointment (with confirmation) -->
