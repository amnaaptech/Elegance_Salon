...
// Fetch all records from the `product_banner` table
...
if (isset($_GET['delete_id'])) {
	...
	$delet_query = "DELETE FROM `product_banner` WHERE id = '$GET_ID';";
...
<body class="cbp-spmenu-push">
	<div class="main-content">
		...
		<div class="container">
			<h1 class="text-center my-5">Product Banners</h1>
					...
					<?php if ($result->num_rows > 0): ?>
						<?php while ($row = $result->fetch_assoc()): ?>
							<tr>
								...
								<td>
									<img src="../p_imgs/<?php echo $row['Product_Image']; ?>" alt="Banner Image" style="width: 100px; height: auto;">
								</td>
								<td>
									<a href="edit_prod_banner.php?edit_id=<?php echo $row['id']; ?>" class="btn btn-sm btn-warning">Edit</a>
									<a href="show_prod_banner.php?delete_id=<?php echo $row['id']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure you want to delete this banner?');">Delete</a>
								</td>
							</tr>
						<?php endwhile; ?>
					<?php else: ?>
