...
<head>
	...
	<title>Admin Panel - Show Services</title>
		...
		<body class="cbp-spmenu-push">
			<div class="main-content">
				<div class="container shadow-lg my-5">
					<h1 class="display-4 text-center mb-4 mt-5">Show Services</h1>
					<div class="row">
						<?php
						...
						if (mysqli_num_rows($val) > 0) {
							while ($row = mysqli_fetch_assoc($val)) { ?>
								<div class="col-md-4 mb-3">
									<div class="card">
										<img src="../p_imgs/<?php echo htmlspecialchars($row['Image']); ?>" class="card-img-top" alt="Service Image">
										<div class="card-body">
											<h5 class="card-title"><?php echo htmlspecialchars($row['Title']); ?></h5>
											<p class="card-text"><?php echo htmlspecialchars($row['Description']); ?></p>
											<p class="card-text"><strong>Price: </strong><?php echo htmlspecialchars($row['Price']); ?></p>
											<a href="edit_service.php?editid=<?php echo $row['id']; ?>" class="btn btn-warning">Edit</a>
											<a href="show_service.php?deleteeid=<?php echo $row['id']; ?>" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this service?');">Delete</a>
										</div>
									</div>
								</div>
						<?php
					...
					<div class="text-center mb-4">
						<a href="add_service.php" class="btn btn-warning col-12">Add Services</a>
					</div>
				</div>
			</div>
			<!-- Main Content End -->
