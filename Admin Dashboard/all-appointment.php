...
if (false) {
	...
	if ($_GET['delid']) {
		$sid = $_GET['delid'];
		mysqli_query($con, "delete from appointments where ID ='$sid'");
...
?>
			...
			<div class="header-right">
				<div class="profile_details_left"><!--notifications of menu start -->
					<ul class="nofitications-dropdown">
						...
						$ret1 = mysqli_query($con, "select registration.Name,appointments.id,appointments.id from appointments join registration on registration.id=appointments.id where appointments.status is null");
							...
							<ul class="dropdown-menu">
								...
								<li>
									<div class="notification_desc">
										...
										?>
												<a class="dropdown-item" href="view-appointment.php?viewid=<?php echo $result['id']; ?>">New appointment received from <?php echo $result['fullname']; ?> (<?php echo $result['id']; ?>)</a>
												<hr />
											<?php }
										} else { ?>
	...
	<div class="sidebar" role="navigation">
		...
		<div class="main-content">
			<div id="page-wrapper">
				<div class="main-page">
					<div class="tables">
						<h3 class="title1" style="color: black;">All Appointment</h3>
						<div class="table-responsive hover bs-example widget-shadow">
    ...
    FROM appointments 
    JOIN registration ON registration.id = appointments.id
");
									// $cnt = 1;
									...
									?>
										...
										<tr>
											...
											<?php } else { ?>
												<td><?php echo $row['status']; ?></td><?php }?></td>
										</tr> <?php
												$cnt = $cnt + 1;
											} ?>
								</tbody>
