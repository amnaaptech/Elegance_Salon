...
if (isset($_POST['insert'])) {
	...
	$stmt = $con->prepare("INSERT INTO `product_banner` (`Product_Title`, `Adress`, `Number`, `Product_Image`) VALUES (?, ?, ?, ?)");
	...
	$stmt->bind_param("ssss", $banner_title, $banner_address, $banner_number, $banner_img);
	...
	if ($stmt->execute()) {
		...
		echo "Data is not inserted: " . $stmt->error;
	}
...
<body class="cbp-spmenu-push">
	<div class="main-content">
		...
		<div class="main-content">
			...
			<div class="container">
				<h1 class="display-1 text-center my-5">Add Products Banner</h1>
				<div class="card p-4 shadow-lg">
					<form action="" method="post" enctype="multipart/form-data">
						...
						<div class="form-group mb-3">
							...
							<input type="text" name="b_address" class="form-control" id="p_t" required>
						</div>
						<div class="form-group mb-3">
							<label for="p_p" class="font-weight-bold">Number:</label>
							<input type="text" name="b_n" class="form-control" id="p_p" required>
						</div>
						<div class="form-group mb-3">
							<label for="b_img" class="font-weight-bold">Banner Image:</label>
							<input type="file" name="b_img" class="form-control" id="b_img" required>
						</div>
						<div class="text-center">
							<a href="show_prod_banner.php" class="btn btn-primary btn-lg">Show Banner</a>
							<input type="submit" name="insert" class="btn btn-primary btn-lg" value="Add Banner">
						</div>
					</form>
				</div>
			</div>
